"""Default prompts - extracted from LangChain git history.

Source: https://github.com/langchain-ai/chat-langchain commit c0de6a3^ (Oct 2024)

These are the REAL prompts used by LangChain team in production before
migration to private LangSmith Hub. Since langchain-ai/* prompts are private
and inaccessible even with API keys, we use these battle-tested prompts.

Quality: Professional, production-proven prompts from LangChain team.
"""
